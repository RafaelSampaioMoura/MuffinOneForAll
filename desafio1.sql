...
INSERT INTO
  SpotifyClone.Planos (plano_id, plano_nome, valor)
VALUES
  (1, 'gratuito', 0.00),
  (2, 'familiar', 7.99),
...
INSERT INTO
  SpotifyClone.Albums (album_nome, ano_lancamento, artista_id)
VALUES
  ('Renaissance', 2022, 1),
  ('Jazz', 1978, 2),
  ('Hot Space', 1982, 2),
...
INSERT INTO
  SpotifyClone.Cancoes (cancao_nome, duracao_segundos, album_id)
VALUES
  ('BREAK MY SOUL', 279, 1),
...
INSERT INTO
  SpotifyClone.Favoritos (usuario_id, cancao_id, ultima_reproducao)
VALUES
